                    ...
                    <div className="bg-white p-6 rounded-lg max-w-md w-full shadow-xl transform transition-all">
                        ...
                        <div className="flex justify-end gap-4">
                            <button
                                ...
                                className="px-4 py-2 cursor-pointer text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded"
                            ...
                            <button
                                ...
                                className="px-4 py-2 cursor-pointer bg-red-500 text-white rounded hover:bg-red-600 disabled:bg-gray-400 disabled:cursor-not-allowed"
                            >
